...
void BBWin8Game::CreateD3dDevice(){
	...
	bool swapDimensions=false;//(_orientation==DisplayOrientations::Portrait) || (_orientation==DisplayOrientations::PortraitFlipped);
